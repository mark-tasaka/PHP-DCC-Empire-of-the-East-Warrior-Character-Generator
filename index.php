...
<html>
<head>
<title>Launch Page: Warrior Character Generator Dungeon Crawl Classics</title>
	...
	<script type="text/javascript" src="js/WarriorMenu.js"></script>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Warrior Character Generator Dungeon Crawl Classics" class="image" /></h1>
        ...
        <p>The Dungeon Crawl Classics Empire of the East Warrior Character Generator has been designed primarily with PHP. Several  functions are stored in external files, as a means of creating greater design efficiency, with the goal of writing a program with high cohesion and low coupling. In this way, this program simulates Object-Oriented design.</p>
		...
		<form action="" id ="WarriorFormV3"  target="_blank" method="post">
        ...
        <div class="formIputDescription">
           ...
           <br/>
            ...
            <span class="formIputDescription">Lucky Weapon:</span>	
			  <select id="luckyWeaponV3" name="theLuckyWeapon" class="alignmentBox">			
				<option value="0" >Battleaxe</option>
				<option value="4">Crossbow</option>
				<option value="7">Flail</option>
				<option value="9">Handaxe</option>
				<option value="10">Javelin</option>
				<option value="11">Lance</option>
				<option value="12">Longbow</option>
				<option value="13" selected>Longsword</option>
				<option value="14">Mace</option>
				<option value="15">Polearm</option>
				<option value="16">Shortbow</option>
				<option value="17">Short sword</option>
				<option value="18">Sling</option>
				<option value="19">Spear</option>
				<option value="20">Staff</option>
				<option value="21">Two-handed sword</option>
				<option value="22">Warhammer</option>
			  </select>
		...
		<div class="content8">
            ...
            <br/>
                ...
                <script>
                   ...
                   $("#WarriorFormV3").attr('action', "character/dccWarrior.php");
